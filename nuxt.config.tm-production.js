...
const baseURL = 'https://crm-api.ecommercehub.unifi.com.my/'

const firebaseConfig = {
  apiKey: 'AIzaSyD6rvwaLE_uourPw1pIv-IzZBRMvANp2vw',
  authDomain: 'crm-tm-development.firebaseapp.com',
  databaseURL:
    'https://prime-crm-tm-production-default-rtdb.asia-southeast1.firebasedatabase.app',
  projectId: 'prime-crm-tm-production',
  storageBucket: 'prime-crm-tm-production.appspot.com',
  messagingSenderId: '911710894083',
  appId: '1:911710894083:web:cfceb00384425e66c33636',
  measurementId: 'G-7BQH9EX0VZ',
}
...
export default {
  ...
  env: {
    ...
    DOMAIN_SSO: 'https://sso.ecommercehub.unifi.com.my/',
    DOMAIN_WEB: 'https://web-cms.ecommercehub.unifi.com.my/',
    DOMAIN_WEB_FE: '.web.ecommercehub.unifi.com.my/',
    DOMAIN_POS: '.pos.ecommercehub.unifi.com.my/',
    DOMAIN_DISTRIBUTION: 'https://distribution.ecommercehub.unifi.com.my/',
    DOMAIN_KOL: 'https://primeinfluencer.asia/',
    DOMAIN_CRM: 'https://crm.ecommercehub.unifi.com.my/',
  },
