<template>
  <div class="templates-auto-response-setup-content">
    ...
    >
      ...
      <div class="drawer-add-template__content">
        <div class="templates-type-drawer">
          <div class="templates-type-drawer__content">Add auto response</div>
        </div>
      </div>
    </a-drawer>
  </div>
    ...
    async fetchTemplates(sort) {
      try {
        ...
        const params = {
          ...
          'filter[type]': this.configResponseTemplate.type['auto-response'],
        }
        const { data, meta } =
