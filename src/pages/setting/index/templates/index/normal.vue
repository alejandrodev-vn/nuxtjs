<template>
  <div class="templates-normal-setup-content">
      ...
      <div class="drawer-add-template__content">
        <div class="templates-type-drawer">
          <div class="templates-type-drawer__content">
            <templates-example @reload="fetchTemplates" />
          </div>
        </div>
      </div>
    </a-drawer>
    ...
    async fetchTemplates(sort) {
      try {
        ...
        const params = {
          ...
          'filter[type]': this.configResponseTemplate.type.normal,
        }
        const { data, meta } =
