          ...
          callbacks: {
            ...
            label: (tooltipItem, data) => {
              ...
              label += !tooltipItem.yLabel
                ? `0 ${this.$t('order')}`.toLowerCase()
                : tooltipItem.yLabel === 1
                ? `${tooltipItem.yLabel} ${this.$t('order')}`.toLowerCase()
                : `${tooltipItem.yLabel} ${this.$t('orders')}`.toLowerCase()
              return label
            },
          },
        },
