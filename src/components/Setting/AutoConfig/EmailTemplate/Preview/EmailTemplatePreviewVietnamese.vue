  ...
  <div class="email-template-preview">
      ...
      <div class="grid grid-cols-2 gap-4">
        <div>
          <div class="flex justify-between my-1">
            <span class="block">Họ và tên</span>
    ...
    <div class="email-template-preview-order-information">
      ...
      <div class="grid grid-cols-2 gap-4">
        <div>
          <div class="flex justify-between my-1">
            <span class="block">Trạng thái đơn hàng</span>
          ...
          >
            <span class="block">Ngày hủy đơn</span>
          ...
          <div
            ...
            class="flex justify-between my-1"
          >
            <span class="block">Ngày giao hàng</span>
          ...
          <div
            ...
            class="flex justify-between my-1"
          >
            <span class="block">Ngày thất bại</span>
            <span class="block">{{ failedDate }}</span>
          </div>
        </div>
        <div>
          <div class="flex justify-between my-1">
            <span class="block">Ngày đặt hàng</span>
          ...
          <div
            ...
            class="flex justify-between my-1"
          >
            <span class="block">Lý do hủy</span>
      ...
      <div class="grid grid-cols-2 gap-4 mt-2">
        <div>
          <div class="flex justify-between my-1">
            <span class="block">Phương thức thanh toán</span>
            <span class="block text-gray">{{ method }}</span>
          </div>
          <div class="flex justify-between my-1">
            <span class="block">Đơn vị vận chuyển</span>
            <span class="block text-gray">{{ provider }}</span>
          </div>
        </div>
        <div>
          <div class="flex justify-between my-1">
            <span class="block">Ghi chú từ người bán</span>
...
<script>
export default {
  name: 'EmailTemplatePreviewVietnamese',
  props: {
    type: {
      type: String,
      default: '',
